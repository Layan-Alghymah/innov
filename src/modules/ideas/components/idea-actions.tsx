...
import { submitIdeaAction, withdrawIdeaAction, archiveIdeaAction, type IdeaActionState } from "@/modules/ideas/actions";
...
export function IdeaActionBar({ ideaId, flags }: { ideaId: string; flags: IdeaActionFlags }) {
  if (!flags.canEdit && !flags.canSubmit && !flags.canWithdraw && !flags.canArchive) return null;
  return (
